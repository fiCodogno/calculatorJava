...
public class Teclado extends JPanel implements ActionListener{
    ...
    private final Color COR_CINZA_ESCURO = new Color(65, 65, 65);
    private final Color COR_CINZA_CLARO = new Color(100, 100, 100);
    private final Color COR_LARANJA = new Color(240, 165, 60);
